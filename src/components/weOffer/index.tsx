...
const WeOffer = () => {
  return (
    <section className="we-offer-section-bg mt-32 pb-10  pt-10 dark:bg-dark">
        ...
        <div className="  mt-14 px-4 sm:px-6">
          <div className="wow fadeInUp" data-wow-delay=".2s">
            <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-2">
              <WobbleCard containerClassName="col-span-1 lg:col-span-1 h-full bg-pink-800 min-h-[500px] lg:min-h-[300px]">
                ...
                <div className="w-10">
                  <img
                    ...
                    className="absolute -bottom-10 -right-4 h-full w-full  rounded-2xl object-contain lg:-right-[55%]"
                  />
                </div>

                <button
                  type="submit"
                  className="text-md group relative isolation-auto z-10 mt-7 flex items-center justify-center gap-2 overflow-hidden rounded-full border-2 border-gray-50 bg-gray-50 px-4 py-2 shadow-xl backdrop-blur-md before:absolute before:-left-full before:-z-10 before:aspect-square before:w-full before:rounded-full before:bg-black before:transition-all before:duration-700 hover:text-gray-50 before:hover:left-0 before:hover:w-full before:hover:scale-150 before:hover:duration-700 lg:font-semibold"
                >
                  Get started
                  <svg
                    className="h-7 w-7 rotate-45 justify-end rounded-full border border-gray-700 p-2 text-gray-50 duration-300 ease-linear group-hover:rotate-90 group-hover:border-none group-hover:bg-gray-50"
                    viewBox="0 0 16 19"
              ...
              <WobbleCard containerClassName="col-span-1 h-full min-h-[500px] lg:min-h-[300px]">
                <div className="max-w-xs">
              ...
              <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
                <div className="max-w-sm">
                  <h2 className="max-w-sm text-balance  text-left text-base font-semibold tracking-[-0.015em] text-white md:max-w-lg md:text-xl lg:text-4xl">
                    Actogo ERP Platform
                  </h2>
                ...
                <div className="w-10">
                  <img
                    ...
                    alt="linear demo image"
                    className="absolute -bottom-10 -right-10 h-full w-full rounded-2xl object-contain md:-right-[40%] lg:-right-[40%]"
                  />
                </div>
