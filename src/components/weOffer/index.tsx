...
const WeOffer = () => {
  return (
    <section className="we-offer-section-bg sm:pt-18 sm:pb-18 pb-10 pt-10 md:pb-24 md:pt-24">
        ...
        <div className=" mt-14 px-4 sm:px-0">
          <div className="wow fadeInUp" data-wow-delay=".2s">
            <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2 lg:gap-8">
              {/* First Card */}
              <WobbleCard containerClassName="col-span-1 lg:col-span-1 h-full bg-pink-800 min-h-[320px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[300px]">
                <div className="max-w-xs">
                  <h2 className="text-balance text-left text-lg font-semibold tracking-[-0.015em] text-white sm:text-xl md:text-2xl lg:text-3xl">
                ...
                <div className="w-10 opacity-10 md:opacity-100">
                  <img
              ...
              {/* Second Card */}
              <WobbleCard containerClassName="col-span-1 h-full min-h-[320px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[300px]">
                <div className="max-w-xs">
                  <h2 className="max-w-80 text-balance text-left text-lg font-semibold tracking-[-0.015em] text-white sm:text-xl md:text-2xl lg:text-3xl">
              ...
              {/* Third Card */}
              <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-blue-900 min-h-[320px] sm:min-h-[500px] md:min-h-[550px] lg:min-h-[400px] xl:min-h-[300px]">
                <div className="max-w-sm">
                  <h2 className="max-w-sm text-balance text-left text-xl font-semibold tracking-[-0.015em] text-white sm:text-2xl md:max-w-lg md:text-3xl lg:text-4xl">
                    Actogo ERP Platform
                  </h2>
