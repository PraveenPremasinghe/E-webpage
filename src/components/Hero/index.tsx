    ...
    <>
      <section className="hero-section relative min-h-screen w-full bg-white">
        <div className="flex h-screen w-full">
          ...
          <div className="hero-glassmorphism-effect flex w-1/3 items-center justify-center ">
            <div className="relative h-screen w-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="   rounded-lg p-8">
                  ...
                  <div>
                    {/* Gradients */}
                    <div className="absolute inset-x-20 bottom-0 h-[4px] w-3/4 bg-gradient-to-r from-transparent via-indigo-500 to-transparent blur-sm" />
                    <div className="absolute inset-x-20 bottom-0 h-px w-3/4 bg-gradient-to-r from-transparent via-indigo-500 to-transparent" />
                    <div className="bottom-0bg-gradient-to-r absolute inset-x-60 h-[7px] w-1/4 from-transparent via-sky-500 to-transparent blur-sm" />
                    <div className="absolute inset-x-60 bottom-0 h-px w-1/4 bg-gradient-to-r from-transparent via-sky-500 to-transparent" />
                  </div>
