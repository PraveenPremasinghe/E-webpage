...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="hero-section relative min-h-screen w-full bg-white"
      >
        <div className=" hero-content h-full w-full sm:px-6 lg:px-32 ">
          <div className="flex h-full flex-col items-center justify-between gap-8 py-12 md:py-16 lg:flex-row lg:py-20">
            ...
            <div className="flex  flex-col justify-center space-y-6 lg:w-2/3 ">
              <div className="glassmorphism-effect h-fit w-fit  p-10">
                <h1 className="text-4xl font-normal tracking-tight text-white dark:text-neutral-400 sm:text-5xl md:text-6xl lg:text-7xl">
