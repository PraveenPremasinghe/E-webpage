...
const Hero = () => {
    ...
    <>
      <section className="hero-section relative min-h-screen w-full bg-white">
        <div className="flex flex-col lg:flex-row  h-screen w-full">
          ...
          {/* Left side - Red background */}
          <div className="hero-glassmorphism-effect flex w-full md:w-2/5 items-center justify-center">
  <div className="relative h-screen w-full flex flex-col">
    ...
    <div className="absolute inset-0 h-full w-full">
      ...
      {/* Radial Gradient */}
      <div
        className="absolute inset-0 h-full w-full bg-black [mask-image:radial-gradient(500px_500px_at_center,transparent_20%,white)]"></div>
    </div>
    ...
    <div className="relative pb-4">
     ...
     <div>
          {/* Gradients */}
       <div
         className="absolute inset-x-30 bottom-0 h-[6px] w-3/4 bg-gradient-to-r from-transparent via-indigo-500 to-transparent blur-sm" />
          <div
            className="absolute inset-x-30 bottom-0 h-px w-3/4 bg-gradient-to-r from-transparent via-indigo-500 to-transparent" />
          <div
            className="bottom-0bg-gradient-to-r absolute inset-x-60 h-[9px] w-1/4 from-transparent via-sky-500 to-transparent blur-sm" />
          <div
            className="absolute inset-x-70 bottom-0 h-px w-1/4 bg-gradient-to-r from-transparent via-sky-500 to-transparent" />
        </div>
  </div>
</div>
