  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="mt-4 border-t border-gray-200 bg-white pb-3 md:hidden">
            {/* Mobile menu items */}
            {navigationItems.map((item) => {
              const isActive = isNavItemActive(item);
              return item.submenu ? (
      ...
      {mobileSelectedItemData && (
        <div className=" inset-0 z-50 mt-20 overflow-y-auto bg-white p-4">
          ...
          <div className="space-y-6">
            {mobileSelectedItemData.tabs?.map((tab: any, index: number) => (
              <div key={index}>
                ...
                <div className="mt-8 rounded-lg bg-gradient-to-r from-pink-600 to-pink-800 p-4 text-white">
                  ...
                  <button className="mt-4 rounded-md bg-white px-4 py-2 font-medium text-pink-700">
                    Request Demo
                  </button>
                </div>
              </div>
